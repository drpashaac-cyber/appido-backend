...
const plans_admin_controller_1 = require("./plans-admin.controller");
...
exports.PlansModule = PlansModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [plans_controller_1.PlansController, plans_admin_controller_1.PlansAdminController],
